...
interface SolunivoAppleCalendarNative {
 ...
 */
export const loadAppleCalendarModule = (): SolunivoAppleCalendarNative | undefined => {
  try {
    return requireNativeModule<SolunivoAppleCalendarNative>('SolunivoAppleCalendar');
  } catch {
    return undefined;
  }
};
